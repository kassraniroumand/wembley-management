            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mt-1">support@eventhub.com</p>
                    <p className="text-muted-foreground">info@eventhub.com</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
              ...
              <div className="mt-12">
                ...
                <p className="text-muted-foreground mb-4">
                  Follow us on social media for updates, tips, and event management inspiration.
                </p>
